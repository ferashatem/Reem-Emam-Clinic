...
const links = [
  ...
  { to: '/super-admin/clients', label: 'Clients', icon: '👤' },
  { to: '/super-admin/services', label: 'Services', icon: '✨' },
  { to: '/super-admin/reservations', label: 'Reservations', icon: '📅' },
  { to: '/super-admin/reports', label: 'Reports', icon: '📋' },
  { to: '/super-admin/reviews', label: 'Reviews', icon: '⭐' },
  { to: '/super-admin/contact-requests', label: 'Contact Requests', icon: '📬' },
